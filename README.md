...
- **OAuth credentials**: This public modified edition intentionally replaces upstream bundled Google OAuth client credentials with non-sensitive placeholders. Configure your own OAuth client before using the affected Antigravity or Gemini CLI authorization flows.
