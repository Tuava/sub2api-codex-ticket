<template>
  <div class="flex flex-col gap-0.5">
    <!-- 并发槽位 -->
    <CapacityBadge :color-class="concurrencyClass" :current="currentConcurrency" :max="maxConcurrency">
...
const maxConcurrency = computed(() => props.account.effective_concurrency || props.account.concurrency)
