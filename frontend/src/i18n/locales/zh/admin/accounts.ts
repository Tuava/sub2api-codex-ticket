export default {
    accounts: {
      ...
      dataImportResultSummary: '代理创建 {proxy_created}，复用 {proxy_reused}，失败 {proxy_failed}；账号创建 {account_created}，失败 {account_failed}；批量配置 {post_import_updated}，配置失败 {post_import_failed}；智能分配 {proxy_assigned}，分配失败 {proxy_assign_failed}',
      ...
      proxyLanes: {
        title: '代理并发泳道',
        hint: '每条代理拥有独立并发额度、权重、超时和熔断配置；账号总容量取已启用泳道容量之和。',
        primary: '主代理',
        maxConcurrency: '最大并发',
        weight: '权重',
        timeout: '超时（秒）',
