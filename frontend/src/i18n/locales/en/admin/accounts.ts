export default {
    accounts: {
      ...
      dataImportResultSummary: 'Proxies created {proxy_created}, reused {proxy_reused}, failed {proxy_failed}; Accounts created {account_created}, failed {account_failed}; Batch configured {post_import_updated}, config failed {post_import_failed}; Smart assigned {proxy_assigned}, assignment failed {proxy_assign_failed}',
      ...
      proxyLanes: {
        ...
        hint: 'Each proxy has independent capacity, weight, timeout, and circuit-breaker settings. Account capacity is the sum of enabled lanes.',
        primary: 'Primary',
