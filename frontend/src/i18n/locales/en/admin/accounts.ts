export default {
    accounts: {
      ...
      dataExportIncludeTicketInfo: 'Include ticket info (including the original ticket value)',
      dataImport: 'Import',
      ...
      dataExportConfirmMessage: 'The export contains account credentials and proxy details. When tickets are selected it also contains original ticket values. Store it as a sensitive backup.',
      ...
      dataImportTicketInfoDetected: 'Detected {count} tickets. Original values present in the file will be restored unchanged by the server.',
      ...
      dataImportResultSummary: 'Proxies created {proxy_created}, reused {proxy_reused}, failed {proxy_failed}; Accounts created {account_created}, failed {account_failed}; Tickets restored {ticket_restored}; Batch configured {post_import_updated}, config failed {post_import_failed}; Smart assigned {proxy_assigned}, assignment failed {proxy_assign_failed}',
      dataImportBulkConfigTitle: 'Post-import Batch Edit',
      dataImportProfileEditorTitle: 'Import Profile Editor',
      dataImportBulkConfigHint: 'Uses the complete batch account editor; settings apply only to accounts created by this import.',
      dataImportConfigure: 'Configure',
      dataImportSaveBulkConfig: 'Save Import Settings',
      dataImportBulkConfigReady: '{count} batch configuration fields saved and will be applied after import.',
      dataImportProfilesTitle: 'Import Configuration Profiles',
      dataImportProfilesHint: 'Save multiple batch-edit and smart-proxy configurations, then switch with one click. Profiles stay in this browser and can be exported for another browser.',
      dataImportProfilesListHint: 'Each profile contains both batch-edit and smart-proxy settings. Select one directly from the list when importing.',
      dataImportProfilesEmpty: 'No configuration profiles yet',
      dataImportProfilesEmptyHint: 'Create a profile, then use, edit, copy, export, or delete it here.',
      dataImportProfileNew: 'New Profile',
      dataImportProfileName: 'Profile Name',
      dataImportProfileUse: 'Use',
      dataImportProfileInUse: 'In Use',
      dataImportProfileBatchSummary: 'Batch Settings',
      dataImportProfileProxySummary: 'Smart Proxy',
      dataImportProfileUpdatedAt: 'Updated {time}',
      dataImportProfileNoBatchConfig: 'Do not change account fields',
      dataImportProfileBatchConfigured: 'Advanced account settings configured',
      dataImportProfileProxyDisabled: 'Smart proxy disabled',
      dataImportProfileProxyCount: '{count} proxies per account',
      dataImportProfileLatencyTestEnabled: 'Test latency first',
      dataImportProfileLatencyTestDisabled: 'Keep existing latency',
      dataImportProfileFastestCandidates: 'Fastest {count} candidates',
      dataImportProfileAllHealthyCandidates: 'All healthy proxies',
      dataImportProfilePreferLatency: 'Prefer low latency',
      dataImportProfileUniformLatency: 'Uniform latency weight',
      dataImportProfileWeightedLoad: 'Load weighted',
      dataImportProfileUnweightedLoad: 'No load weighting',
      dataImportProfileConcurrency: 'Concurrency {value}',
      dataImportProfileLoadFactor: 'Load factor {value}',
      dataImportProfilePriority: 'Priority {value}',
      dataImportProfileRateMultiplier: 'Rate multiplier {value}',
      dataImportProfileStatus: 'Status {value}',
      dataImportProfileMainProxy: 'Primary proxy {value}',
      dataImportProfileGroups: '{value} group(s)',
      dataImportProfileBillingProbe: 'Billing probe {value}',
      dataImportProfileBaseUrl: 'Base URL {value}',
      dataImportProfileModels: '{value} model rule(s)',
      dataImportProfileErrorCodes: 'Error codes {value}',
      dataImportProfileWarmup: 'Warmup interception {value}',
      dataImportProfileHeaders: '{value} header override(s)',
      dataImportProfileCapabilities: '{value} endpoint capability item(s)',
      dataImportProfilePassthrough: 'OpenAI passthrough {value}',
      dataImportProfileLongContext: 'Long-context billing {value}',
      dataImportProfileOAuthWs: 'OAuth WS {value}',
      dataImportProfileApiKeyWs: 'API Key WS {value}',
      dataImportProfileRpm: 'RPM {value}',
      dataImportProfileUmq: 'UMQ {value}',
      dataImportProfileCopyName: '{name} Copy',
      dataImportProfileCopied: 'Profile “{name}” copied',
      dataImportProfileNamePlaceholder: 'Profile name, e.g. OpenAI High Concurrency',
      dataImportProfileSaveAs: 'Save as New Profile',
      dataImportProfileOverwrite: 'Overwrite Current Profile',
      dataImportProfileExport: 'Export Profile',
      dataImportProfileImport: 'Import Profile',
      dataImportProfileNameRequired: 'Enter a profile name',
      dataImportProfileEmptyConfig: 'Configure batch settings or enable smart proxy assignment first',
      dataImportProfileNameExists: 'A profile with this name already exists',
      dataImportProfileSaved: 'Profile “{name}” saved',
      dataImportProfileUpdated: 'Profile “{name}” updated',
      dataImportProfileApplied: 'Switched to profile “{name}”',
      dataImportProfileImported: 'Profile “{name}” imported',
      dataImportProfileImportFailed: 'Invalid or unsupported profile file',
      dataImportProfileDeleteConfirm: 'Delete profile “{name}”?',
      dataImportProfileScopeWarning: 'The current JSON platform or account type differs from this profile. Review platform-specific settings.',
      dataImportProfileStorageFailed: 'The browser could not save profiles. Export a profile file as backup.',
      dataImportErrors: 'Error Details',
      dataImportSuccess: 'Import completed: accounts {account_created}, failed {account_failed}, tickets restored {ticket_restored}',
      dataImportCompletedWithErrors: 'Import completed with errors: account failed {account_failed}, proxy failed {proxy_failed}, batch config failed {post_import_failed}, proxy assignment failed {proxy_assign_failed}',
      ...
      smartProxy: {
        title: 'Smart Random Proxy Assignment',
        hint: 'Tests proxy latency, then dynamically weights latency and current account load to spread pressure evenly.',
        proxyCount: 'Parallel proxies per account',
        proxyCountHint: 'The first becomes primary; the rest join the concurrent proxy pool.',
        lowLatencyLimit: 'Low-latency candidate count',
        lowLatencyLimitHint: '0 uses all healthy proxies; e.g. 20 selects only from the fastest 20.',
        testLatency: 'Retest latency before assignment',
        testLatencyHint: 'Tests all available proxies concurrently; failed proxies are excluded.',
        preferLowLatency: 'Prefer low-latency proxies',
        preferLowLatencyHint: 'Lower latency gives a higher random selection probability.',
        weightedByLoad: 'Spread by proxy load',
        weightedByLoadHint: 'Proxies with fewer bound accounts and lower planned pressure receive more assignments.',
        apply: 'Assign Random Proxies',
        assigning: 'Testing and assigning...',
        success: 'Smart proxy assignment complete: {success} succeeded, {failed} failed, {proxies} candidates',
        failed: 'Smart proxy assignment failed'
      },
      ...
      openai: {
        ...
        codexTurnTicket: 'Codex Turn State ticket',
        codexTurnTicketDesc: 'Shows target length, observed length, rate limits and the missing-ticket scheduling policy. Ticket values are never shown.',
        codexTurnTicketMissing: 'No valid ticket; requests remain allowed',
        codexTurnTicketReady: 'Target ticket · {time} left',
        codexTurnTicketPaused: 'No target {length} ticket; model is paused',
        codexTicketTargetMode: 'Ticket target mode',
        codexTicketTargetAuto: 'Detect account type',
        codexTicketTargetManual: 'Manual length',
        codexTicketTargetLength: 'Target length',
        codexTicketTargetLengthInvalid: 'Target length must be between 128 and 2048',
        codexTicketMissingPolicy: 'When target ticket is missing',
        codexTicketMissingPause: 'Pause account/model scheduling',
        codexTicketMissingAllow: 'Continue without ticket injection',
        codexTicketAutoResolved: 'Auto target: {length} ({source})',
        codexTicketSourceBusiness: 'Team/Business',
        codexTicketSourcePersonal: 'Personal plan',
        codexTicketSourceManual: 'Manual',
        codexTicketSourceDefault: 'System default',
        codexTicketStatusDetail: 'Target {target} · observed {current} · missing policy: {policy}',
        codexTicketPolicyPauseShort: 'pause',
        codexTicketPolicyAllowShort: 'continue',
        codexTicketNextProbe: 'next probe {time}',
        codexTicketTypeNonTarget: 'Non-target ticket',
        codexTicketTypeExpired: 'Target ticket expired',
        codexTicketTypeRateLimited: 'Upstream rate limited',
        codexTicketTypeQuotaExhausted: 'Quota exhausted',
        codexTicketTypeError: 'Probe error',
        codexTicketTypeDisabled: 'Model disabled',
        codexTicketProbeNow: 'Probe now',
        codexTicketProbing: 'Probing…',
        codexTicketProbeFailed: 'Manual ticket probe failed',
        codexTicketProbeSuccess: 'Target ticket captured: {model} · {length}/{target}',
        codexTicketProbeNonTarget: 'Probe completed, but the result is not the target ticket: {model} · {current}/{target}',
        codexTicketProbeNonTargetPreserved: 'This probe returned a non-target ticket; the existing valid ticket for {model} was preserved',
        codexTicketProbeRateLimited: 'Probe completed: upstream rate limited {model}; no ticket captured',
        codexTicketProbeError: 'Probe completed without a ticket: {model} · {reason}',
        codexTicketProbeStage: {
          queued: 'Preparing manual ticket probe',
          validating: 'Validating account and model',
          persisting_policy: 'Saving current ticket policy',
          acquiring_token: 'Acquiring account access token',
          requesting_upstream: 'Requesting upstream through harvest proxy',
          validating_response: 'Validating upstream ticket response',
          persisting_result: 'Persisting probe result',
          refreshing_status: 'Refreshing account ticket status',
          completed: 'Manual ticket probe completed',
          failed: 'Manual ticket probe failed'
        },
        codexTicketProbeLog: {
          probe_queued: 'Manual ticket probe queued',
          validating_account: 'Reading and validating account state',
          validation_passed: 'Account and model validated: {model}',
          persisting_policy: 'Saving the visible model policy',
          acquiring_token: 'Acquiring account token; target length {target_length}',
          token_ready: 'Account token is ready',
          sending_probe: 'Sending request through the dedicated harvest proxy',
          response_received: 'Upstream response received: HTTP {http_status}, length {observed_length}/{target_length}',
          token_unavailable: 'Account token unavailable; recording the failure',
          request_failed: 'Upstream request failed; recording the failure',
          probe_superseded: 'Policy changed; this stale probe result was discarded',
          persisting_observation: 'Persisting probe observation: {outcome}',
          persisting_ticket: 'Target ticket matched; persisting length {length}',
          refreshing_status: 'Reloading persisted ticket status',
          probe_completed: 'Operation completed: {outcome}',
          probe_failed: 'Operation failed; see the page message for details'
        },
      ...
      proxy: 'Proxy',
      noProxy: 'No Proxy',
      proxyPool: 'Concurrent Proxy Pool',
      proxyPoolHint: 'Business requests rotate across the primary and selected proxies; authorization, refreshes, and tests keep using the primary proxy.',
      proxyPoolEmpty: 'No additional proxies',
      proxyPoolSelected: '{count} additional proxies selected',
      proxyLanes: {
        title: 'Proxy Concurrency Lanes',
        hint: 'Proxies only handle routing and live occupancy. Capacity, weight, timeout, and circuit-breaker settings apply to the whole pool.',
        primary: 'Primary',
        unifiedSettings: 'Unified proxy-pool settings',
        unifiedSettingsHint: 'These settings apply to the primary and every parallel proxy. Fallback order follows the selected proxy order automatically.',
        accountConcurrency: 'Account concurrency',
        accountConcurrencyHint: 'Change this in the Concurrency field above; capacity is split across lanes automatically.',
        unifiedSummary: 'Unified W{weight} · timeout {timeout}s · circuit after {threshold} errors · cooldown {cooldown}s',
        maxConcurrency: 'Max concurrency',
        weight: 'Weight',
        timeout: 'Timeout (sec)',
        circuitThreshold: 'Errors to circuit',
        circuitCooldown: 'Circuit cooldown (sec)',
        ...
        strategy: {
          ...
          least_connections: 'Least-connections scheduling',
          weighted: 'Weighted scheduling'
        }
      },
