export default {
  ...
  version: {
    ...
    githubRateLimited: 'The GitHub API rate limit is exhausted and the fallback release source was also unavailable. Retry later or configure UPDATE_GITHUB_TOKEN.',
    githubRateLimitedUntil: 'The GitHub API rate limit and fallback release source are unavailable. Retry after {time}, or configure UPDATE_GITHUB_TOKEN.',
    githubUnavailable: 'Both the GitHub API and fallback release source are unavailable: {message}',
